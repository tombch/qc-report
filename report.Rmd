...
# Organise into grid
samples = grid.arrange(samples_by_date, totals_by_week, ncol=2, nrow=1)
ggsave(paste(prefix, "samples_by_date_and_week.png", sep="_"), samples, width=w, height=h)
...
totals_by_seq = df %>%
    ...
    theme_bw() +
    theme(legend.position="bottom")
ggsave(paste(prefix, "totals_by_seq.png", sep="_"), totals_by_seq, width=w, height=h)
...
ggsave(paste(prefix, "totals_by_seq_and_pp.png"), totals, width=w, height=h)
...
![](`r paste(prefix, "samples_by_date_and_week.png", sep="_")`)
